...
-- aparcamiento. El aparcamiento es un tablero de 6 filas y 6 columnas.
--------------------------------------------------------------------------------------

-------------------------------------- OBJETIVO --------------------------------------
-- Se desarrollará un programa que dado una situación inicial (comienzo del juego)
-- lo clasifique por su dificultad: principiante, intermedio, avanzado y experto.
-- Para ello se propondrá una fórmula (polinomio) en función de características de la
-- solución mínima, por ejemplo, número de pasos, proporción de piezas movidas, grado de
